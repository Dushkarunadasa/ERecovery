<%@ Page Title=" Allowance" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="WeekendExtra_Duty.aspx.cs" Inherits="ERecs.WeekendExtra_Duty" %>
...
<asp:Content ID="Main" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h5>1/20 Allowance - Data Entry Form...</h5>
            ...
            <ContentTemplate>
                ...
                <div class="form-group row">                   
                    ...
                    <asp:Label ID="lblGrade" class="col-sm-1 col-form-label" runat="server" Text=""></asp:Label>
                        <label for="Rate" class="col-sm-2 col-form-label">Consolidated Salary :</label>
                    <asp:Label ID="lblBasic" class="col-sm-1 col-form-label" runat="server" Text=""></asp:Label>
    ...
    <div class="form-group row">
        ...
        <asp:RangeValidator ID="Rangevalidator1" ErrorMessage="Please enter value between 1-23." ForeColor="Red" ControlToValidate="txtfromhr" MinimumValue="1" MaximumValue="23" runat="server" Type="Integer">
        </asp:RangeValidator>
    ...
    <div class="form-group row">
        ...
        <asp:RangeValidator ID="Rangevalidator3" ErrorMessage="Please enter value between 1-23." ForeColor="Red" ControlToValidate="txttohh" MinimumValue="1" MaximumValue="23" runat="server" Type="Integer">
        </asp:RangeValidator>
    ...
    <div class="form-group row">
        <label for="remarks1" class="col-sm-2 col-form-label">Details of 1/20 Duty</label>
    ...
    <div class="alert  alert-dismissible alert-info">
        ...
        <p class="mb-0">Medical and Dental Officers are elagible for 1/20 allowance.Payment is done for the duties which has done on Weekends or public holidays.
            Officer should cover 6 hours duty turn per day to algible for this allowance.Further this allowance pay only 3 days per month..</p>
