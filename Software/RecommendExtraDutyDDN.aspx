<%@ Page Title="ExtraDuty" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="RecommendExtraDutyDDN.aspx.cs" Inherits="ERecs.RecommendExtraDutyDDN" %>

<asp:Content ID="Main" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    <h5>Doctor's Allowances - Approve...</h5>
                        ...
                        <ContentTemplate>
                            <fieldset>
                                <div class="form-group row">
                                    ...
                                    <asp:GridView ID="GVTransConfirmed" runat="server"  class="table table-dark table-striped"  OnRowCommand="GVTransConfirmed_RowCommand">
                                        <Columns>
